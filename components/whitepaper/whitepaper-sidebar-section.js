...
export default function WhitepaperSidebarSection() {
  return (
      ...
      <div className="fugu-blog-sidebar">
          ...
          <form action="#">
            <div className="fugu-product-search">
              ...
              <button id="fugu-search-btn">
                <Image src="/images/svg/search.svg" alt="Search" width={24} height={24} />
              </button>
            </div>
          </form>
        </div>
        ...
        <div className="fugu-sidebar-item">
          ...
          <div className="fugu-recent-post-item">
            <Link href={"/"}>
              <Image src="/images/all-img/blog/recent-post1.png" alt="Post 1" width={500} height={300} />
            </Link>
          ...
          <div className="fugu-recent-post-item">
            <Link href={"/"}>
              <Image src="/images/all-img/blog/recent-post2.png" alt="Post 2" width={500} height={300} />
            </Link>
            <div className="fugu-blog-meta">
              <ul>
                <li>
          ...
          <div className="fugu-recent-post-item">
            <Link href={"/"}>
              <Image src="/images/all-img/blog/recent-post3.png" alt="Post 3" width={500} height={300} />
            </Link>
            <div className="fugu-blog-meta">
              <ul>
                <li>
