				...
				<div className="row">
					<div className="col-lg-5 offset-lg-1 order-lg-2">
						<div className="fugu-video-thumb wow fadeInUpX" data-wow-delay=".20s">
							<img src="/id/images/all-img/product_image4.png" alt="" style={{width:"auto",height:"auto"}}/>
					...
					<div className="col-lg-6 col-md-10 d-flex align-items-center">
						<div className="fugu-default-content large-content">
							...
							<div className="fugu-icon-list">
								<ul>
									<li>
									<img src="/id/images/svg/new_icons-05.png" alt="" />
									...
									<li>
									<img src="/id/images/svg/new_icons-03.png" alt="" />
									...
									<li>
									<img src="/id/images/svg/new_icons-04.png" alt="" />
									...
									<li>
									<img src="/id/images/svg/new_icons-02.png" alt="" />
