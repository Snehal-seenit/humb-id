      ...
      <div className="container">
          ...
          <div className="col-lg-4">
            <div className="fugu-textarea">
              <div className="fugu-footer-logo">
                <img
                  src="/id/images/all-img/Background.png"
                  alt="footer-logo"
        ...
        <div className="fugu-social-icon">
          <ul className="justify-content-center">
            ...
            <li>
              <Link
                href="https://www.linkedin.com/company/99412147/admin/dashboard/"
                target="_blank"
                rel="noopener noreferrer"
              >
                {/* <svg
                ...
                >
                  <path
                    d="M7 9H9V17H7V9ZM8 6C7.45 6 7 6.45 7 7C7 7.55 7.45 8 8 8C8.55 8 9 7.55 9 7C9 6.45 8.55 6 8 6ZM11 9H13V10.3C13.5 9.5 14.5 9 15.5 9C17.43 9 18 10.24 18 12.08V17H16V12.5C16 11.5 15.78 11 15 11C14.22 11 14 11.5 14 12.5V17H12V9H11Z"
                    fill="white"
                  />
                </svg>
              </Link>
            ...
            <li>
              <Link
                href="https://t.me/HUMBExchange/27030"
                target="_blank"
                rel="noopener noreferrer"
              >
                <svg
            ...
            <li>
              <Link
                href="https://www.youtube.com/@HUMBexchange/"
                target="_blank"
                rel="noopener noreferrer"
              >
                <svg
            ...
            <li>
              <Link
                href="https://www.reddit.com/r/Humbio/"
                target="_blank"
                rel="noopener noreferrer"
              >
                <svg
            ...
            <li>
              <Link
                href="http://tiktok.com/@humbindonesia"
                target="_blank"
                rel="noopener noreferrer"
              >
                <svg
